...
app.use((req, res, next) => {
  var allowedOrigins = ["http://localhost:8082", "http://localhost:8083"]
...
app.post("/api/post/danhmuc/mota", (req, res, next) => {
  ...
  var filePath = `/app/outsideAssets/description/${req.body.tennh.toLowerCase()}/${req.body.tendm.toLowerCase()}/${
    req.body.tennh
  }-${req.body.tendm}.html`
